...
@push('title')
    Perpus App | Master Penerbit
@endpush

@section('content')
<div class="p-4 pb-12 pt-20 sm:ml-72">
    <div class="my-4 text-center">
        <h2 class="text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Master Penerbit <span class="bg-blue-100 text-blue-800 text-2xl font-semibold mr-2 px-2.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">Beta</span></h2>
    ...
    <div class="container bg-white mx-auto min-h-96 h-auto min-w-96 w-full rounded-xl shadow dark:bg-slate-800 border-slate-700 border">
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Data Penerbit</h3>
                        <form id="createForm" class="space-y-6" action="#" enctype="multipart/form-data"
                            onsubmit="event.preventDefault(); create();"
                        >
                            @csrf
                            <div>
                                <label for="id_penerbit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Penerbit</label>
                                <div class="flex">
                                    ...
                                    <input type="text" id="id_penerbit" name="id_penerbit" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="ex: S0001">
                                    </div>
                            </div>
                            <div>
                                <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Penerbit</label>
                                <div class="flex">
                                    <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"/>
                            ...
                            <div>
                                ...
                                <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                        <label for="alamat" class="sr-only">Publish post</label>
                                        <textarea id="alamat" name="alamat" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" id="kota" name="kota" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="ex: George Orwell">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" id="telepon" name="telepon" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="ex: George Orwell">
                                        </div>
                                </div>
                            </div>
                            ...
                            {{-- <div class="flex flex-col items-center justify-center w-full">
                                <label for="foto" class="block text-sm font-medium text-gray-900 dark:text-white text-left self-start">Foto Penerbit</label>
                                <label for="foto" class="flex flex-col items-center justify-center w-full h-64 mt-3 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
        ...
        <div id="editModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Edit Data Penerbit</h3>
                        <form class="space-y-6" action="#">
                            <div>
                                <label for="nis" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIS (Nomor Induk Penerbit)</label>
        ...
        <button data-modal-target="editModal" data-modal-toggle="editModal" class="relative  inline-flex hidden items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-teal-300 to-lime-300 group-hover:from-teal-300 group-hover:to-lime-300 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800">
...
<script>
    ...
    function fetchDataAndAppendToTable(params, pageUrl = "{{ route('dashboard.master-penerbit.getData') }}") {
        // Make a GET request using Axios with the provided params
        // axios.get("{{ route('dashboard.master-penerbit.getData') }}", {
        //     params: params
        // })
        axios.get(pageUrl, {
            params: params
            ...
            .then(function (response) {
                ...
                // <td class="px-6 py-4"><a href="${assetUrl}/${item.foto}">${item.foto}</a></td>
                const rowTemplate = (item) =>
                `
                    <tr class="bg-white text-center border-b dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${item.id_penerbit}</td>
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${item.kota}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${item.telepon}</td>
                        <td class="px-6 py-4 text-center">
                            <button data-modal-target="editModal" data-modal-toggle="editModal" class="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-teal-300 to-lime-300 group-hover:from-teal-300 group-hover:to-lime-300 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800">
                                <span class="relative p-2 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                    <svg class="w-3 h-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
    ...
    function handleInput(event) {
        ...
        fetchDataAndAppendToTable(params);
    }
    ...
    function handleDeleteAction(id) {
        ...
        confirmButton.addEventListener('click', () => {
            ...
            axios
                .post(`{{ route('dashboard.master-penerbit.delete') }}`, {
                    _method: 'DELETE',
                    id: id
                })
                .then(response => {
                    // Handle the response (e.g., show a success message)
                    console.log('Penerbit deleted successfully', response);
                    fetchDataAndAppendToTable(); // Refresh the table after deletion
                })
                .catch(error => {
                    // Handle any errors (e.g., show an error message)
                    console.error('Error deleting Penerbit', error);
                });
    ...
    function create() {
        ...
        axios.post("{{ route('dashboard.master-penerbit.create') }}", formData)
            .then(response => {
                // Handle the response (e.g., show a success message)
                console.log('Penerbit created successfully', response);
                fetchDataAndAppendToTable(); // Refresh the table after deletion
